...
3. Adjust the canvas size: **Image** > **Canvas Size**. Because the 1632x1042px image is taller than the optimal 1280x640px GitHub size, we first adjust the canvas size. We have to add some width. So here adjust the width to 2084px [`1042 * 2` or `10342 * (1280 / 640)`] and keep the height at 1042px.
